...
> AI-powered SEO & GEO readiness scanner. Analyzes crawlability, structured data, and AI search visibility across 5 categories. Free scan tier, REST API, CLI (`npx foglift scan`), and MCP server for AI agents.
