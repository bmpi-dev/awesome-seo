...
> Free API for generating Open Graph images from templates via URL parameters, helping websites control how their pages appear in social media and search result previews.
