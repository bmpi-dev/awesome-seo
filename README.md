...
> Free URL metadata extraction API that retrieves title, description, Open Graph tags, and favicons from any URL, useful for auditing link previews and on-page SEO elements.
