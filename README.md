...
> Intent signal monitoring CLI. Track LinkedIn engagers, keyword posters, job changers, and funding events. JSON output for agent pipelines. `npm i -g signals-sortlist-cli`
